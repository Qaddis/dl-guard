...
export const mtls: MaterialsLiType[] = [
	{
		...
		techs: ["Python 3.11", "JavaScript", "HTML", "CSS"]
	},
	{
		title: "Server",
	...
	},
	{
		...
		techs: ["Arduino Nano (ATmega328P)", "PN 532"]
	},
	{
		title: "Mobile",
		description:
		...
		howWork:
			"Пользователь через свой логин и пароль входит в приложение, после чего ему на телефон сохраняется <i>уникальный идентификатор</i> (<i>UID</i>). После авторизации пользователь может приложить телефон с включенным <i>NFC</i> к <i>считывающему устройству</i>, которое через <i>NFC</i> получит с телефона сохранённый ранее <i>UID</i>.",
